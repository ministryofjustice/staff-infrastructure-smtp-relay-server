...
echo "$HOSTNAME@ip-10-180-104-23.eu-west-2.compute.internal $HOSTNAME@$RELAY_DOMAIN" >> /etc/postfix/sender_canonical # temporary address mapping to test in development environment
